...
const CropManage = {
    ...
    cropImage(instance, cb) {
        ...
        cb.call(null,URL.createObjectURL(CropManage.compressImage(canvas)))
    },
    ...
    renderImage(instance) {
        ...
        instance.imageInstance.canvasImage.src = URL.createObjectURL(CropManage.compressImage(canvas))
